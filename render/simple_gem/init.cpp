...
GLuint program;
GLuint vbo_triangle, index_buffer, UV_buffer, normals_buffer;
GLint attribute_coord4d, attribute_UV_coords, attribute_normals;
GLint uniform_theta, uniform_model_view, uniform_projection, uniform_light;
GLfloat u_theta[] = { 0.0, 0.0, 0.0 };
GLfloat u_light[] = { 0.0, 0.0,-2.0 };
GLfloat rotation_velocity = 0.0, x_light_velocity = 0.0f, y_light_velocity = 0.0f;
...
bool init_resources(void){
  FILE *file_handle = fopen( "square_gem.3d", "rb" );
